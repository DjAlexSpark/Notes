...
public class HelloController implements Initializable {
    ...
    void onClickAddButton(ActionEvent event) {
        ...
        list2.get(list2.size()-1).setOnAction(actionEvent -> {
            try {
                ...
                FXMLLoader fxmlLoader = new FXMLLoader(com.example.notes.HelloApplication.class.getResource("noteWindow.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        uploadButton.setOnAction(event-> {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(com.example.notes.HelloApplication.class.getResource("uploadWindow.fxml"));
                Scene scene = new Scene(fxmlLoader.load());//,450,250
                Stage stage = new Stage();
                stage.initModality(Modality.APPLICATION_MODAL);//не дает обратиться назад
